...
function Header({color}:any) {
  ...
  return (
    <div>
        <div className={'top-4 left-8 text-3xl absolute text-blue-900 z-50 cursor-pointer'+
        ...
        <nav className='absolute top-6 right-8 w-64 flex flex-row-reverse space-x-8 space-x-reverse'>
            <li className={'list-none text-xl z-50 text-blue-900 cursor-pointer'.concat(headerColor)}>
                <BsCart4/>
            </li>
            <li className={'list-none text-blue-900 z-50 cursor-pointer '.concat(headerColor).concat(themeFont.className)}>
                About
            </li>
            <li className={'list-none text-blue-900 z-50 cursor-pointer '.concat(headerColor).concat(themeFont.className)}>
                <Link href="/products">
